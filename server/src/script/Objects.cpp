    ...
    luax::ModuleHandle module)
{
...

    {
        ...
        type.method("get_move_y", &Player::get_move_y);
        type.method("set_move_y", &Player::set_move_y);
        type.method("get_run", &Player::get_run);
        type.method("set_run", &Player::set_run);
        type.method("get_prone", &Player::get_prone);
        type.method("set_prone", &Player::set_prone);
        type.method("get_want_prone", &Player::get_want_prone);
        type.method("set_want_prone", &Player::set_want_prone);
        type.method("get_running", &Player::get_running);
        type.method("set_running", &Player::set_running);
        type.method("get_stamina", &Player::get_stamina);
        type.method("set_stamina", &Player::set_stamina);
        type.method("get_stamina_delay", &Player::get_stamina_delay);
        type.method("set_stamina_delay", &Player::set_stamina_delay);
        type.method("get_stamina_rem", &Player::get_stamina_rem);
        type.method("set_stamina_rem", &Player::set_stamina_rem);
        type.method("get_health_delay", &Player::get_health_delay);
        type.method("set_health_delay", &Player::set_health_delay);
        type.method("get_health_rem", &Player::get_health_rem);
        type.method("set_health_rem", &Player::set_health_rem);
        type.method("get_melee_ticks", &Player::get_melee_ticks);
        type.method("set_melee_ticks", &Player::set_melee_ticks);
        type.method("get_ladder_id", &Player::get_ladder_id);
        type.method("set_ladder_id", &Player::set_ladder_id);
        type.method("get_selected_slot", &Player::get_selected_slot);
        type.method("set_selected_slot", &Player::set_selected_slot);
        type.method("get_use_slot", &Player::get_use_slot);
        type.method("set_use_slot", &Player::set_use_slot);
        type.method("get_use_ticks", &Player::get_use_ticks);
        type.method("set_use_ticks", &Player::set_use_ticks);
        type.method("get_melee", &Player::get_melee);
        type.method("set_melee", &Player::set_melee);
        type.method("get_segment_count", &Player::get_segment_count);
        type.method("get_segment", &Player::get_segment);
        type.method("get_weapon_count", &Player::get_weapon_count);
        type.method("get_active_weapon", &Player::get_active_weapon);
        type.method("switch_weapon", &Player::switch_weapon);
        type.method("get_weapon_cfg", &Player::get_weapon_cfg);
        type.method("get_weapon_reserve", &Player::get_weapon_reserve);
        type.method("set_weapon_reserve", &Player::set_weapon_reserve);
        type.method("get_tool_cfg", &Player::get_tool_cfg);
        type.method("get_tool_count", &Player::get_tool_count);
        type.method("get_tool_instance", &Player::get_tool_instance);
        type.method("change_tool", &Player::change_tool);
        type.method("start_use", &Player::start_use);
        type.method("cancel_use", &Player::cancel_use);
        type.method("finish_use", &Player::finish_use);
        type.method("get_use_instance", &Player::get_use_instance);
        type.method("get_weapon_ammo", &Player::get_weapon_ammo);
        type.method("set_weapon_ammo", &Player::set_weapon_ammo);
        type.method("get_weapon_shot_ticks", &Player::get_weapon_shot_ticks);
        type.method("set_weapon_shot_ticks", &Player::set_weapon_shot_ticks);
        type.method("get_weapon_reload_ticks", &Player::get_weapon_reload_ticks);
        type.method("set_weapon_reload_ticks", &Player::set_weapon_reload_ticks);
    ...
    type.method("get_world_id", &World::get_world_id);
    type.method("scene_count", &World::scene_count);
    type.method("scene_used", &World::scene_used);
    type.method("set_scene_used", &World::set_scene_used);
    type.method("projectile_free", &World::projectile_free);
    type.method("spawn_projectile", &World::spawn_projectile);
    type.method("projectile_alive", &World::projectile_alive);
    type.method("read_projectile", &World::read_projectile);
    type.method("write_projectile", &World::write_projectile);
    type.method("remove_projectile", &World::remove_projectile);
    type.method("clear_actions", &World::clear_actions);
